...
<body>
        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="sneat-1.0.0/sneat-1.0.0/html/index.php">Data siswa</a></li>
                    ...
                    <li class="log"><a href="forms/login.php"><button type="button" class="btn btn-primary rounded-pill">Login</button></a></li>
                </ul>
    ...
    <section id="hero">
        <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
            ...
            <h2>You are a great and strong person, Keep spirit</h2>
            <a href="#about" class="btn-get-started">SMKN 1 PASURUAN</a>
        </div>
    </section>
    <!-- End Hero Section -->
            ...
            <div class="container" data-aos="fade-up">
                <div class="row about-container">
                    ...
                    <div class="col-lg-6 content order-lg-1 order-2">
                        ...
                        Puji syukur kepada Allah SWT, Tuhan Yang Maha Esa yang telah memberikan rahmat dan anugerahNya sehingga website SMK Negeri 1 Pasuruan ini dapat terbit untuk menjawab akan setiap kebutuhan informasi dengan memanfaatkan sarana teknologi informasi yang ada. <br>
                        Kami sadar sepenuhnya dalam rangka memajukan pendidikan di era berkembangnya Teknologi Informasi yang begitu pesat, sangat diperlukan berbagai sarana prasarana yang kondusif, kebutuhan berbagai informasi siswa, guru, orangtua maupun masyarakat, sehingga kami berusaha mewujudkan hal tersebut semaksimal mungkin. Semoga dengan adanya website ini dapat membantu dan bermanfaat, terutama informasi yang berhubungan dengan pendidikan, ilmu pengetahuan dan informasi seputar SMK Negeri 1 Pasuruan.
        ...
        <section id="services">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="zoom-in">
                        <div class="box">
                            <div class="icon"><a href=""><i class="bi bi-buildings-fill"></i></a></div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="zoom-in">
                        <div class="box">
                            <div class="icon"><a href=""><i class="bi bi-code-slash"></i></i></a></div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="zoom-in">
                        <div class="box">
                            <div class="icon"><a href=""><i class="bi bi-pc-display"></i></a></div>
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="info">
              <div>
                ...
                <p> Jl. Veteran, Bugul Lor <br>Kec. Panggungrejo, Kota Pasuruan, Jawa Timur 67122</p>
              </div>
