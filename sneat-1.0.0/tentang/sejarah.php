...
<body>
    ...
    <!-- ======= Header ======= -->
    <header id="header" class="bg-dark fixed-top d-flex align-items-center header-transparent">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a href="../forms/login.php"><button type="button" class="btn btn-primary rounded-pill">Login</button></a></li>
                </ul>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center p-5">
                    ...
                    <div class="icon-box">
                        <!-- <div class="  "><i class="bx bx-fingerprint"></i></div> -->
                        <h4 class="title"><a href="">Sejarah SMK</a></h4>
                        <p class="description">SMK Negeri 1 Pasuruan bermula dari Sekolah Menengah Ekonomi Pertama (SMEP) yang berdomisili di Jalan Veteran 11 Pasuruan, Telp. 0343-421380, dibangun diatas tanah seluas 8950 meter persegi berdasarkan sertifikat No. 886/ 1985. Pada tahun 1977 dengan SK No 0278/U/1976 dari SMEP diintegrasikan menjadi SMP yang disempurnakan. Pada Tahun pelajaran baru 1978 ditingkatkan menjadi SLTA Kejuruan (SMEA Negeri) Pasuruan dengan lampiran Keputusan Menteri Pendidikan dan Kebudayaan tanggal 30 Juli 1980 No. 0209/0/1980. Pada Tahun 2000 SMEA Negeri Pasuruan diubah nama menjadi SMK Negeri 1 Pasuruan Kelompok Bisnis dan Manajemen dan Kelompok Teknologi.</p>
                    </div>
